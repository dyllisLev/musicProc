...
class ModelItem(db.Model):
    ...
    def save_as_dict(d):
        try:
            ...
            entity = ModelItem()
            entity.status = str(d['status'])
            entity.title = str(d['title'])
            entity.artist = str(d['artist'])
            entity.album = str(d['album'])
            entity.titleByTag = str(d['titleByTag'])
            entity.artistByTag = str(d['artistByTag'])
            entity.albumByTag = str(d['albumByTag'])
            entity.filePath = str(d['filePath'])
            entity.searchKey = str(d['searchKey'])
            entity.statusCd = str(d['statusCd'])
